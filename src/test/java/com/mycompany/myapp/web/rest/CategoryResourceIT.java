...
class CategoryResourceIT {
    ...
    private static final Integer DEFAULT_XML_CATEGORY_ID = 1;
    private static final Integer UPDATED_XML_CATEGORY_ID = 2;
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().xmlCategoryId(DEFAULT_XML_CATEGORY_ID).parentId(DEFAULT_PARENT_ID).name(DEFAULT_NAME);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().xmlCategoryId(UPDATED_XML_CATEGORY_ID).parentId(UPDATED_PARENT_ID).name(UPDATED_NAME);
        return category;
    }
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getXmlCategoryId()).isEqualTo(DEFAULT_XML_CATEGORY_ID);
    ...
    void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc
            ...
            .andExpect(jsonPath("$.[*].xmlCategoryId").value(hasItem(DEFAULT_XML_CATEGORY_ID)))
    ...
    void getCategory() throws Exception {
        ...
        restCategoryMockMvc
            ...
            .andExpect(jsonPath("$.xmlCategoryId").value(DEFAULT_XML_CATEGORY_ID))
    ...
    void putNewCategory() throws Exception {
        ...
        updatedCategory.xmlCategoryId(UPDATED_XML_CATEGORY_ID).parentId(UPDATED_PARENT_ID).name(UPDATED_NAME);
        ...
        Category testCategory = categoryList.get(categoryList.size() - 1);
        assertThat(testCategory.getXmlCategoryId()).isEqualTo(UPDATED_XML_CATEGORY_ID);
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.xmlCategoryId(UPDATED_XML_CATEGORY_ID);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.xmlCategoryId(UPDATED_XML_CATEGORY_ID).parentId(UPDATED_PARENT_ID).name(UPDATED_NAME);
